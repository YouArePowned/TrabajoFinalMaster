...
def serve(
    ...
    agent_loop = AgentLoop(
        ...
        require_tool_confirmation=runtime_config.agents.defaults.require_tool_confirmation,
    )
...
def _run_gateway(
    ...
    *,
    ...
    agent = AgentLoop(
        ...
        require_tool_confirmation=config.agents.defaults.require_tool_confirmation,
    )
